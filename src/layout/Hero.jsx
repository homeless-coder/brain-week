    ...
    <section className="w-full mt-15">
        <div className="flex flex-col sm:flex-row sm:justify-center gap-x-5 py-8">
            <div className="font-extrabold w-full text-center">
                <p style={{ textShadow: '0 2.1px 3.1px rgba(0, 0, 0, 0.18)' }} className="shadow-none mb-4.5 font-[1000] text-black text-md lg:text-md">TE INVITAMOS A DISFRUTAR DE:</p>
                <h1 style={{ textShadow: '0 2.1px 3.1px rgba(0, 0, 0, 0.30)' }} className="shadow-none font-monomakh tracking-widest mb-1.5 text-3xl lg:text-4xl font-black tracking-tight leading-none dark:text-black">LA SEMANA DEL</h1>
                ...
                <h2 style={{ textShadow: '0 2.1px 3.1px rgba(0, 0, 0, 0.21)' }} className="shadow-none font-monomakh tracking-wider mb-7.5 text-2xl lg:text-2xl font-extrabold tracking-tight leading-none dark:text-black">¡VEN Y DIVIÉRTETE!</h2>
            </div>
